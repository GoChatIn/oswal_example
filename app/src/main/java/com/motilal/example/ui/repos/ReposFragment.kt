package com.motilal.example.ui.repos
...
import com.motilal.example.data.model.Languages
import com.motilal.example.databinding.FragmentReposBinding
import com.motilal.example.ui.repos.adapter.ReposAdapter
import com.motilal.example.ui.repos.adapter.ReposLoadStateAdapter
...
class ReposFragment : Fragment(R.layout.fragment_repos) {
    ...
    private fun periodikworkrequest(){
        /*val workmanager= WorkManager.getInstance(requireContext())
        val constrants = Constraints.Builder()
            .setRequiredNetworkType(NetworkType.CONNECTED)
            .build()
        */
       /* val periodikworkrequest = PeriodicWorkRequest.Builder(FetchDataWorker(requireContext(), FetchDataWorker(), viewModel)::class.java,15,
            TimeUnit.MINUTES)

            .build()
        WorkManager.getInstance(requireContext()).enqueue(periodikworkrequest)*/
    }
